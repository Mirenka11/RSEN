...
\newcommand{\Subject}{Regulace a senzory}  %odkomentujte dle potřeby

%  Máte-li více spoluměřících než jednoho, vložte jen jejich příjmení
\newcommand{\Author}{Kateřina Hrnečková}
...
\newcommand{\Title}{Spojitá regulovaná soustava se servomotorem HSM 60 se spojitou regulací}
\newcommand{\Labdate}{22.11.2024} %datum měření, nikoli datum odevzdání
